      ...
      <div class="collapse navbar-collapse text-center" id="navbar2SupportedContent">
        <ul class="navbar-nav">
          <li class="nav-item active">
            <a class="nav-link" href="iciciHome.jsp">Home
              <span class="sr-only">(current)</span>
            </a>
          </li>
          <c:if test = "${empty sessionScope.customer}">
          <li class="nav-item">
            <a class="nav-link" href="login.jsp">Edit Profile</a>
          </li>
          
          <li class="nav-item">
            <a class="nav-link" href="login.jsp">Dashboard</a>
          </li>
        </ul>
        <ul class="navbar-nav mr-auto">
          <li class="nav-item ">
            <a class="nav-link" href="about.jsp">
              <i class="fa d-inline fa-lg fa-bookmark-o"></i>About</a>
          </li>
        ...
        <c:if test = "${empty sessionScope.customer}">
        <a class="btn navbar-btn ml-2 text-white btn-dark" href="login.jsp">
          <i class="fa d-inline fa-lg fa-user-circle-o"></i> Sign in</a>
          </c:if>
          
          <c:if test = "${not empty sessionScope.customer}">
          Welcome,${sessionScope.customer.customerName}
          <a class="btn navbar-btn ml-2 text-white btn-dark" href="logout.do">
